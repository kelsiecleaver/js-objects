...
var completePerson = buildPerson(plainPerson, "Shelbie", 21);
console.log(buildPerson(plainPerson));
console.log(buildPerson("Shelbie"));
console.log(buildPerson(21));
...
*/
var sumObj = {a: 17, b: 26, result: "undefined"};
function objectAddition(apple){
 ...
 */
function printObj(apple){
  return apple.a + " + " + apple.b + " = " + apple.result;
}
